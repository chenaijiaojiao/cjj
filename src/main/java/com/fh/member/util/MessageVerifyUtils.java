...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4GConqaPCWJpTdmVRXHw";           // TODO 改这里
    static final String accessKeySecret = "5dD2BhnMp6WG9MiTxn9b1pYL7nZ9xn"; // TODO 改这里
    ...
    public static SendSmsResponse sendSms(String userPhone, String userCode) throws ClientException {
        ...
        // 必填:短信签名-可在短信控制台中找到
        request.setSignName("CJJ商城"); // TODO 改这里
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_196653291");  // TODO 改这里
 ...
 /*public static void main(String[] args) throws Exception {
         ...
         SendSmsResponse sendSms =sendSms("18595924051",code);//填写你需要测试的手机号码
         System.out.println("短信接口返回的数据----------------");
         System.out.println("Code=" + sendSms.getCode());
         System.out.println("Message=" + sendSms.getMe());
         System.out.println("RequestId=" + sendSms.getRequestIdessag());
